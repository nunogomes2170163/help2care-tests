Feature: Manage Materials
  ...
  Scenario: Access Text Material Edit Page
    ...
    Then I should be redirected to the "edit" page of the material - USfive
    And the editable field "type" should show "Texto" - USfive
    And the editable field "name" should show "Cucumber Text2263972" - USfive
  ...
  Scenario: Edit Text Material Successfully
    Given I access the "edit" page of the "text" "Cucumber Text2263972" material - USfive
    ...
    Then I should be redirected to the "details" page of the "Text Edit" material - USfive
    And the field from details "material" should show "Cucumber Text Edit" - USfive
    And the field from details "type" should show "Texto" - USfive
    And the field from details "description" should show "Cucumber Text Description Edit" - USfive
    And the field from details "text" should show "Cucumber Text Very Detailed Text Edit" - USfive
