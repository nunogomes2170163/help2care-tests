Feature: Behavior on conflicts
  ...
  Scenario: Move up the same material from the same composite material in two different sessions
    ...
    Then the "O material ELIMINAÇAO VESICAL - 2 já não se encontra na mesma posição, quando a operação de ordenamento da lista de materiais foi solicitada." error message should be shown on session 2 - UStwelve
  ...
  Scenario: Add the same material to the same composite material in two different sessions
    ...
    Then the "O material Como mudar a fralda já se encontra na lista de materiais do material composto ELIMINAÇAO VESICAL." error message should be shown on session 2 - UStwelve
  ...
  Scenario: Remove the same material from the same composite material in two different sessions
    ...
    Then the "O material Como mudar a fralda já não se encontra na lista de materiais do material composto ELIMINAÇAO VESICAL." error message should be shown on session 2 - UStwelve
  ...
  Scenario: Move up the same question from the same quiz in two different sessions
    ...
    Then the "A questão Manuseia/Higieniza colostomia? já não se encontra na mesma posição, quando a operação de ordenamento da lista de questões foi solicitada." error message should be shown on session 2 - UStwelve
  ...
  Scenario: Add the same question to the same quiz in two different sessions
    ...
    Then the "A questão Aplica o desodorizante? já se encontra na lista de questões do qquestionário Avaliação das necessidades do utente dependente - Autocuidado: Intestinal." error message should be shown on session 2 - UStwelve
  ...
  Scenario: Remove the same question from the same quiz in two different sessions
    ...
    Then the "A questão Aplica o desodorizante? já não se encontra na lista de questões do qquestionário Avaliação das necessidades do utente dependente - Autocuidado: Intestinal." error message should be shown on session 2 - UStwelve
  ...
  Scenario: Delete the same material in two different sessions
    ...
    Then the "O material Posicionar a pessoa na cama já se encontra apagado." error message should be shown on session 2 - UStwelve
  ...
  Scenario: Delete the same need in two different sessions
    ...
    Then the "A necessidade Tomar a medicação já se encontra apagada." error message should be shown on session 2 - UStwelve
