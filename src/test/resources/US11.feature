Feature: Behavior on conflicts
  ...
  Scenario: Associating the same Caregiver with 1 healthcare professionals in two different sessions
    ...
    Then the "O cuidador Cidália Pereira já se encontra a ser gerido por 2 profissionais de saúde." error message should be shown on session 2 - USeleven
  ...
  Scenario: Associating the same Caregiver with 0 healthcare professionals in two different sessions
    ...
    Then the "O cuidador Cucumber já se encontra a ser gerido por si." error message should be shown on session 2 - USeleven
  ...
  Scenario: Disassociating the same Caregiver in two different sessions
    ...
    Then the "O cuidador Cucumber já não se encontra a ser gerido por si." error message should be shown on session 2 - USeleven
  ...
  Scenario: Associating the same patient to the same caregiver in two different sessions
    ...
    Then the "O utente Manuel Maria já se encontra associado a um cuidador." error message should be shown on session 2 - USeleven
  ...
  Scenario: Disassociating the same patient to the same caregiver in two different sessions
    ...
    Then the "O utente Manuel Maria já não se encontra associado ao cuidador Caregiver." error message should be shown on session 2 - USeleven
  ...
  Scenario: Associating the same need to the same patient in two different sessions
    ...
    Then the "A necessidade Acamado já se encontra associada ao utente Beatriz Martins." error message should be shown on session 2 - USeleven
  ...
  Scenario: Disassociating the same need to the same patient in two different sessions
    ...
    Then the "A necessidade Acamado já não se encontra associada ao utente Beatriz Martins." error message should be shown on session 2 - USeleven
  ...
  Scenario: Disassociating the same material from the same caregiver in two different sessions
    ...
    Then the "O material Como mudar a fralda já não se encontra associado ao cuidador Helena Carvalho." error message should be shown on session 2 - USeleven
  ...
  Scenario: Disassociating the same need from the same patient in two different sessions
    ...
    Then the "O material Engasgamento já não se encontra associado à necessidade Transferências." error message should be shown on session 2 - USeleven
  ...
  Scenario: Associating the same mobile quiz to the same caregiver in two different sessions
    ...
    Then the "O questionário Avaliação das necessidades do utente dependente - Autocuidado: Andar já foi disponibilizado para resposta na aplicação, mas ainda não foi respondido." error message should be shown on session 2 - USeleven
